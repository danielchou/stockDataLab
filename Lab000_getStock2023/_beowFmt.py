...
def fmt_all_infor_stock(r):
    id, market, open, close, yClose, yHigh, low, estVolume, amp, jumpRate, vR, inV, vMM, vHYY = r["id"], r["market"], r["open"], r["close"], r["yClose"], r["yHigh"], r["low"], r["預估量"], r["amp"], r["jumpRate"], r["量比"], r["周轉率"], r["月量比"], r["半年量比"]
    ss = f'"id":{id},"mk":"{market}","o":{open},"yc":{yClose},"c":{close},"yh":{yHigh},"l":{low},"v":{estVolume},"amp":{amp},"jR":{jumpRate},"vR":{vR},"inV":{inV},"vMM":{vMM},"vYY":{vHYY}'
    return ss
